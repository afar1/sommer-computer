...
class LookupTests(unittest.TestCase):
    ...
    def test_home_page_has_network_status_matrix_markup(self):
        ...
        self.assertIn("data-status-detail", html)
        self.assertIn("status-popover", html)
        self.assertIn("networkStatusPopoverData", html)
        ...
        self.assertIn("data-close-status-popover", html)
